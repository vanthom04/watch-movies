...
const MovieItem: React.FC<MovieItemProps> = ({ name, imageUrl, slug }) => {
  ...
  return (
    <div className="w-44 xs:w-36 md:w-52 sm:w-48" onClick={() => router.push(`/xem-phim/${slug}`)}>
      <div
        className="w-44 h-72 xs:w-36 xs:h-60 sm:w-48 sm:h-72 md:w-52 md:h-80 lg:h-[312px] relative flex rounded-lg overflow-hidden cursor-pointer"
